		...
		<div class="col">
			<form action="/manage/getAddInfo" method="post">
    			...
    			<label for="formGroupExampleInput2">Content</label>
   				 <input type="text" class="form-control" id="newsContent" placeholder="Input news content"/>
  				</div>
  				<div class="form-group">
    			<label for="formGroupExampleInput2">PublishDate:</label>
   				 <input type="text" name="publishDate" class="form-control" id="newsPublish" placeholder="News published date"/>
  				</div>
  				<div class="form-group">
    			<div class="form-check">
     			 <input class="form-check-input" type="checkbox" name="status" id="check" value="Y"/>
